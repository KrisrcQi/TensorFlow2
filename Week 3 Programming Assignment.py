...
def train_model(model, train_data, train_targets, epochs):
    ...
    history = model.fit(train_data, train_targets, epochs = epochs, batch_size = 50, validation_split = 0.15)
...
def get_regularised_model(input_shape, dropout_rate, weight_decay):
    ...
    reg_model = Sequential([
        Dense(64, kernel_regularizer = regularizers.l2(weight_decay), activation = 'relu', input_shape = input_shape, kernel_initializer = 'he_uniform', bias_initializer = 'ones'),
