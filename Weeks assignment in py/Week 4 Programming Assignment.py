...
def get_checkpoint_every_epoch():
    ...
    checkpoint_filenames_epoch = os.path.join(checkpoint_dir, 'checkpoint_{epoch:03d}')
    
    checkpoint_every_epoch = ModelCheckpoint(filepath = checkpoint_filenames_epoch,
                                 freq = 'epoch',
...
def get_model_best_epoch(model):
    ...
    best_checkpoint = 'checkpoints_best_only/checkpoint'
